...
#----------------------------------------------------------
# setwd("D:/Google Drive/LUCAS 2025/0.FAO class")
# path_data <- "D:/Google Drive/LUCAS 2025/2.DATA/"
# library(data.table)
# 
# s2022 <- fread(paste0(path_data,"LUCAS22_corrected_v3.CSV"))
...
write.table(df,"FAO2022_mod.csv",sep=",",quote=F,row.names = F)
