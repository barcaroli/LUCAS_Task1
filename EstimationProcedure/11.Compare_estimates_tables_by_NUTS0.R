...
#---------------------------------
#----------------------------------------------------------
# Input: ./2b.allyears_estimates
#        ./6.allyears_estimates
...
for(i in 1:length(countries)){
  ...
  # Standard estimates
  #-------------------
  c1 <- read.csv(paste0("./2b.allyears_estimates/",countries[i],"_est_all.csv"))
  ...
  c2 <- read.csv(paste0("./6.allyears_estimates/",countries[i],"_est_all.csv"))
  #seleziono solo le stime delle aree 2022
  ...
  t <- formattable(
    est_2[,c("Country","Variable","standard_Area_2022","twophase_Area_2022","area_diff", "area_rel_diff","standard_CV_2022","twophase_CV_2022","cv_diff")],
    list(
