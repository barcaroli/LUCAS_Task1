...
for(i in 1:length(countries)){
  ...
  # Standard estimates
  #-------------------
  c1 <- read.csv(paste0("./2.StandardEstimates2022/",countries[i],"_est_LC1_LU1_NUTS2_24_2022_t.csv"))
  # manipulation 
  ...
  # twophase estimates
  #-------------------
  c2 <- read.csv(paste0("./4.TwoPhaseEstimates2022/",countries[i],"_est_LC1_LU1_NUTS2_24_2022_t.csv"))
