...
dire <- getwd()
direnew1 <- paste(dire, "/6.allyears_estimates/", sep = "")
...
for (i in c(1:27)) {
  country <- countries[i]
  cat("\nCountry:",country)
  filename1 <- paste0("./estimates2009/",country,"_est_LC1_LU1_2009.csv")
  filename2 <- paste0("./estimates2012/",country,"_est_LC1_LU1_2012.csv")
  filename3 <- paste0("./estimates2015/",country,"_est_LC1_LU1_2015.csv")
  filename4 <- paste0("./estimates2018/",country,"_est_LC1_LU1_2018.csv")
  filename5 <- paste0("./4.TwoPhaseEstimates2022/",country,"_est_LC1_LU1_2022.csv")
